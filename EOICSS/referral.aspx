<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="referral.aspx.cs" Inherits="EOICSS.referral" %>
...
.custom {
  ...
  z-index: 999999999;
   ...
   <div id="loading">
    ...
    <asp:HiddenField ID="csshdncpSourcIds" runat="server" Value="A50148C8-0F9A-4948-A55C-06AA3B85EB74" />
    ...
    <input type="hidden" id="cshdnsources" value="Refferal" />
<!---header-->
...
Gunjur Village, Bengaluru East, Bengaluru Urban, Karnataka - 560087				
              </h5> 
            </div>
      ...
      <%--  <a class="tooltip2  mb-2" href="#">
        ...
        <img src="https://rohanbuilders.com/assets/upload/main-projects/residential/Rohan-Viti/South-West-Side-View-of-the-Facade.webp" alt="Rohan Viti 3 BHK Floor Plan" class="img-fluid mt-2">
        <a href="#" class="clsreq-antara btn btn-primary w-100 mt-3">EOI</a>     
    </div>
              ...
              <div id="divmobn" class="modal-body pt-0">
                  <div class="register p-3">
                        <div class="row">
                              ...
                              <input class="form-control txt" name=popup-phone onkeypress="return isNumberKey(event)" id=popup-phone_mob maxlength="10" pattern="[0-9]*" inputmode=numeric autocomplete=off data-validation=length data-validation-length=10-11 required placeholder="Mob No." />
                          </div>
                  ...
                  <div class="register p-3">
                      <div  id=frm_popup>
                        ...
                        <div class="row">
                          ...
                          <div class=form-group>
                              <button type=button id=btn_get_otp_finalsubmit  class="btn btn-primary btn-lg btn-block">Save and Pay</button>
