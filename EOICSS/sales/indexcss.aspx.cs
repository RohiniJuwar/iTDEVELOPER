...
namespace EOICSS.sales
{
    public partial class indexcss : System.Web.UI.Page
    {
        ...
        public void redirectss()
        {
            ...
            Commoncss.SendClass objcm = new Commoncss.SendClass();
            string strqueryddd = "exec [dbSSProcedures].[SP_Insert_TempDetails] '0','" + csshdnSessionids.Value.ToString() + "','" + strids + "','" + csshdncpSourcIds.Value.ToString() + "','" + csshdncpSourdetailds.Value.ToString() + "','" + csshdnProjecids.Value.ToString() + "','" + strToketypidd + "','" + csshdnAmount.Value.ToString().Trim() + "','" + strpreferneccd + "','" + csshdnTokenaccs.Value.ToString().Trim() + "','" + csshdncpUnitNumber.Value.ToString().Trim() + "','Sales','" + csshdncpMobNo.Value.ToString().Trim() + "'";
            ...
            if (dtctrdata.Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    Server.Transfer("/SalesStatus.aspx?ids=" + strfinencrypte);
