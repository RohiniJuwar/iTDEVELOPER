<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="indexcss.aspx.cs" Inherits="EOICSS.sales.indexcss" %>
...
.bs-searchbox{
   ...
   <div id="loading">
    ...
    <asp:HiddenField ID="csshdncpSourcIds" runat="server" Value="032ADB2E-FB9B-42EE-A9DF-E5D1A643F47D" />
    ...
    <asp:HiddenField ID="csshdncpUnitNumber" runat="server" Value="" />
        <%--<asp:HiddenField ID="csshdncpProjectListValues" runat="server" Value='[{"Texts":"Rohan Antara","Values":"4a7983da-e1fe-4e31-a206-2dc95c1f1c13"},{"Texts":"Rohan Antara Phase 2","Values":"d9836553-ea54-4403-bfd0-78d35f5175a7"}]'/>--%>
        <asp:HiddenField ID="csshdncpProjectListValues" runat="server" Value=''/>
        <asp:HiddenField ID="csshdncpProjectName" runat="server" Value="" />
        <asp:HiddenField ID="csshdnutmfrom" runat="server" Value="Sales" />
    </form>

    <input type="hidden" id="cshdnsources" value="Sales" />
<!---header-->
...
--%>
        ...
        <a href="#" id="divclickc" class="clsreq-Antara_Phase_2 btn btn-primary w-100 mt-3 ">Reserve Your Token</a>     
    </div>
