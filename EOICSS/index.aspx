<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="EOICSS.index" %>
...
.custom {
  ...
  z-index: 999999999;
   ...
   <div id="loading">
    ...
    <input type="hidden"  id="cshdnsources" value="Channel Partner" />
<!---header-->
